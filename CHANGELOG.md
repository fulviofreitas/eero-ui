...
* **app:** 6.0.1 follow-ups: network restore, client counts, cards ([#413](https://github.com/fulviofreitas/eero-ui/issues/413)) ([ae767a1](https://github.com/fulviofreitas/eero-ui/commit/ae767a1d8403b279d5b4f976bd086e8ea5b64340))

## [6.0.1](https://github.com/fulviofreitas/eero-ui/compare/v6.0.0...v6.0.1) (2026-09-25)

### 🐛 Bug Fixes

* **app:** 6.0.0 follow-ups from maintainer feedback ([c0e0888](https://github.com/fulviofreitas/eero-ui/commit/c0e08885383b9d7fecb1e12fabdd6d6659a3f66a))
...
* **deps:** bump cryptography from 48.0.1 to 50.0.0 in /backend ([#359](https://github.com/fulviofreitas/eero-ui/issues/359)) ([bb4f917](https://github.com/fulviofreitas/eero-ui/commit/bb4f917682ecacfc6848c02cda6c25a27cbf2d70))
...
* **deps:** bump eero-api to ^6.0.0 and eero-prometheus-exporter to ^3.18.7 ([#345](https://github.com/fulviofreitas/eero-ui/issues/345)) ([9f4594f](https://github.com/fulviofreitas/eero-ui/commit/9f4594f7946adc0ae57a79283c0281d8f83c3fe8)), closes [#338](https://github.com/fulviofreitas/eero-ui/issues/338) [#342](https://github.com/fulviofreitas/eero-ui/issues/342) [#341](https://github.com/fulviofreitas/eero-ui/issues/341) [#331](https://github.com/fulviofreitas/eero-ui/issues/331)
...
* **ci:** suppress '[aw] No-Op Runs' tracker issue ([150ab32](https://github.com/fulviofreitas/eero-ui/commit/150ab32c7ed5c809eb36cad5fbb2e96bb5654f1b))

## [5.2.1](https://github.com/fulviofreitas/eero-ui/compare/v5.2.0...v5.2.1) (2026-07-21)

### 🐛 Bug Fixes

* **ci:** update triage to gpt-4o-mini + gh-aw v0.80.9 + App token for try-fix chain ([5ffb5d0](https://github.com/fulviofreitas/eero-ui/commit/5ffb5d0d4c5f191c39d784ad20cafd6fe231030a))
...
* assign all selected devices to a profile in one call ([#197](https://github.com/fulviofreitas/eero-ui/issues/197)) ([5c78ce7](https://github.com/fulviofreitas/eero-ui/commit/5c78ce7ecf9552bffbe16931b5a0c510e645e89c))

## [4.15.1](https://github.com/fulviofreitas/eero-ui/compare/v4.15.0...v4.15.1) (2026-05-22)

### 🐛 Bug Fixes

* handle variable Eero API response shapes ([#193](https://github.com/fulviofreitas/eero-ui/issues/193), [#194](https://github.com/fulviofreitas/eero-ui/issues/194)) ([#195](https://github.com/fulviofreitas/eero-ui/issues/195)) ([4a0d8e8](https://github.com/fulviofreitas/eero-ui/commit/4a0d8e88cc09988cb67eccc3fd18f67750b1f67f))

## [4.15.0](https://github.com/fulviofreitas/eero-ui/compare/v4.14.1...v4.15.0) (2026-05-21)

### ✨ Features

* **deps:** update eero-packages ([7784361](https://github.com/fulviofreitas/eero-ui/commit/778436177f8a8378d993d4a504e45f5bb77d0192))

## [4.14.1](https://github.com/fulviofreitas/eero-ui/compare/v4.14.0...v4.14.1) (2026-05-21)

### 🐛 Bug Fixes

* coerce uptime and numeric fields from dict shapes ([695d51e](https://github.com/fulviofreitas/eero-ui/commit/695d51e0207efb6a68faeb7f9ebf3d429470404e)), closes [fulviofreitas/eero-prometheus-exporter#61](https://github.com/fulviofreitas/eero-prometheus-exporter/issues/61)

## [4.14.0](https://github.com/fulviofreitas/eero-ui/compare/v4.13.0...v4.14.0) (2026-05-12)

### ✨ Features

* **deps:** update eero packages to 4.1.3 ([8725d86](https://github.com/fulviofreitas/eero-ui/commit/8725d86fb7e1a5aab5b16161518c2d31cfad3f86))

## [4.13.0](https://github.com/fulviofreitas/eero-ui/compare/v4.12.0...v4.13.0) (2026-05-12)

### ✨ Features

* **deps:** update eero packages to 3.14.0 ([8a0331d](https://github.com/fulviofreitas/eero-ui/commit/8a0331d3d836d309b54f62b3472d1ebba0e2e538))
...
* **deps:** update eero packages to 4.1.2 ([020c0b8](https://github.com/fulviofreitas/eero-ui/commit/020c0b805f5c4a940943c9bed4c4ae5a1ce90371))

## [4.10.0](https://github.com/fulviofreitas/eero-ui/compare/v4.9.2...v4.10.0) (2026-04-30)

### ✨ Features

* **deps:** update eero packages to 4.0.7 ([a62d9db](https://github.com/fulviofreitas/eero-ui/commit/a62d9db01324aefcf3020e1c12037d15f50aaf14))

## [4.9.2](https://github.com/fulviofreitas/eero-ui/compare/v4.9.1...v4.9.2) (2026-04-29)

### 🐛 Bug Fixes

* profile pause/unpause logic is inverted ([af9d4ce](https://github.com/fulviofreitas/eero-ui/commit/af9d4ce1e29324e94e22976d5353446be9243865))

## [4.9.1](https://github.com/fulviofreitas/eero-ui/compare/v4.9.0...v4.9.1) (2026-04-22)

### 🐛 Bug Fixes

* **deps:** bump python-dotenv from 1.2.1 to 1.2.2 in /backend ([5379db4](https://github.com/fulviofreitas/eero-ui/commit/5379db4203ef657f4063086d57a8fb16703f7dc8))

## [4.9.0](https://github.com/fulviofreitas/eero-ui/compare/v4.8.3...v4.9.0) (2026-04-21)

### ✨ Features

* **deps:** update eero-packages ([c7895a5](https://github.com/fulviofreitas/eero-ui/commit/c7895a56b16e46920b60c83a35a889888aaa947b))

## [4.8.3](https://github.com/fulviofreitas/eero-ui/compare/v4.8.2...v4.8.3) (2026-04-21)

### 🐛 Bug Fixes

* **deps:** replace deprecated app-id with client-id in create-github-app-token ([1d03508](https://github.com/fulviofreitas/eero-ui/commit/1d03508d5d91aef57717c2885d78bb8e202f6f6e))

## [4.8.2](https://github.com/fulviofreitas/eero-ui/compare/v4.8.1...v4.8.2) (2026-04-20)

### 🐛 Bug Fixes

* **ci:** prevent auto-merge from running before CI checks complete ([857ef2c](https://github.com/fulviofreitas/eero-ui/commit/857ef2c351a748ed2d6b0273a2dc93e5841abf90))
...
* **deps:** update eero-packages ([27547a8](https://github.com/fulviofreitas/eero-ui/commit/27547a8feebce5d69683c677e6a538119c8b0619))

## [4.7.0](https://github.com/fulviofreitas/eero-ui/compare/v4.6.1...v4.7.0) (2026-04-10)

### ✨ Features

* **deps:** update eero packages to 3.12.1 ([728772c](https://github.com/fulviofreitas/eero-ui/commit/728772c4b8c79dc07fc51b12ac95e7c6f4674341))

## [4.6.1](https://github.com/fulviofreitas/eero-ui/compare/v4.6.0...v4.6.1) (2026-04-10)

### 🐛 Bug Fixes

* remove deprecated matchPackageNames and invalid matchDepTypes from renovate config ([ecc0f14](https://github.com/fulviofreitas/eero-ui/commit/ecc0f14ed9ddc56bb968699644a5e84b6bf08733))

## [4.6.0](https://github.com/fulviofreitas/eero-ui/compare/v4.5.2...v4.6.0) (2026-04-10)

### ✨ Features

* **deps:** update eero-packages ([2f86823](https://github.com/fulviofreitas/eero-ui/commit/2f86823f6fa099a88754249688c89e268b0f5a7f))

## [4.5.2](https://github.com/fulviofreitas/eero-ui/compare/v4.5.1...v4.5.2) (2026-04-10)

### 🐛 Bug Fixes

* **ci:** use GitHub App token for semantic-release ([82ffdb6](https://github.com/fulviofreitas/eero-ui/commit/82ffdb6af6ba3a9176451d37469c391998b6200f))
...
* **frontend:** make Technical block consistent and add appliance emojis ([a02f218](https://github.com/fulviofreitas/eero-ui/commit/a02f2185e4e15bac7499bf2a711973672e394112))
...
* **deps:** update eero packages to 3.11.0 ([174655f](https://github.com/fulviofreitas/eero-ui/commit/174655fcbad546e8c9e528d2e7a3233b5b693538))
* **deps:** update eero packages to 4.0.1 ([3583fc0](https://github.com/fulviofreitas/eero-ui/commit/3583fc06f7ceba36cfd749aecb61a8872666fbf9))

### 📚 Documentation

* **readme:** add screenshots with redacted personal information ([aced973](https://github.com/fulviofreitas/eero-ui/commit/aced973b9f44bf5c1c5904164be5f9cc5691371f))

## [4.2.6](https://github.com/fulviofreitas/eero-ui/compare/v4.2.5...v4.2.6) (2026-01-25)

### 🐛 Bug Fixes

* **metrics:** use correct eero-exporter metrics for device signal history ([0e34627](https://github.com/fulviofreitas/eero-ui/commit/0e34627171efc9383c3d1ca976629e5fb5876b9b))

## [4.2.5](https://github.com/fulviofreitas/eero-ui/compare/v4.2.4...v4.2.5) (2026-01-25)

### 🐛 Bug Fixes

* **network,eero:** fix display issues on network and eero pages ([89ccfb4](https://github.com/fulviofreitas/eero-ui/commit/89ccfb40fc3a9d9a06bc7e37616497ddacf46c8c))
...
* **status:** map 'connected' status to 'online' for frontend ([ed9fc64](https://github.com/fulviofreitas/eero-ui/commit/ed9fc64dcfc4effb6a9e01c37d87f7218d5553dd))
