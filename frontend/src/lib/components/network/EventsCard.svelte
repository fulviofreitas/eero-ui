<!--
  ...
  defensively via the shared EventsTable, with a "load older" action using
  the last-loaded event's timestamp as the pagination cursor (backend
  contract).
-->
<script lang="ts">
