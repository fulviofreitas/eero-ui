 ...
 *
 * When `networkId` is provided, the backend scopes the underlying PromQL
 * by network so accounts with multiple networks see data only for the
 * requested network (issue #201).
 */
